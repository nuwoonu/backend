...
public class Student {
    ...
    @CreationTimestamp // insert시 자동으로 일자 삽입하고 싶을경우
    private LocalDateTime crDateTime1; // create_date_time1 datetime(6),
    @CreatedDate // spring boot 설정 후 삽입.
    private LocalDateTime crDateTime2; // create_date_time2 datetime(6),
